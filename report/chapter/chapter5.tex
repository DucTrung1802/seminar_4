...
\begin{itemize}
    ...
    \item minsup cao → cả ba thuật toán đều nhanh
    \item minsup thấp → Apriori chậm nhất, AprioriTid hoặc Hybrid tốt hơn tùy dataset
\end{itemize}
...
minsup cao
→ ít ứng viên → cả 3 thuật toán chạy nhanh → Apriori có thể ngang bằng hoặc nhanh hơn do không tốn ID-list.

minsup thấp
→ nhiều ứng viên → Apriori chậm nhất vì phải quét lại CSDL.
→ AprioriTid và Hybrid vượt trội hơn, đặc biệt khi số vòng lặp lớn.
...
% BẢNG 1
% =======================
\subsection{Bảng tổng hợp số lượng ứng viên và thời gian chạy theo thuật toán (bảng 1)}
...
% BẢNG 2
% =======================
\subsection{Bảng tổng hợp số lượng ứng viên và thời gian chạy theo thuật toán (bảng 2)}
...
% HÌNH 1
% =======================
\subsection{Biểu đồ số lượng ứng viên theo từng vòng}
...
% HÌNH 2
% =======================
\subsection{Biểu đồ thời gian thực thi của ba thuật toán}
